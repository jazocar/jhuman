...
@FacesConverter("tipoParametroConverter")
public class TipoParametroConverter
  implements Converter
{
  private IConfigJProcessService configJProcessService;
  
  public TipoParametroConverter()
  {
  ...
  public String getAsString(FacesContext arg0, UIComponent arg1, Object value)
    throws ConverterException
  {
    return this.configJProcessService.selectTipoParametroById(Integer.parseInt(value.toString())).getNombre();
  }
}
