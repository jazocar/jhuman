...
@FacesConverter(value = "aplicacionBusquedaConverter")
public class AplicacionBusquedaConverter implements Converter {

	private IConfigJProcessService configJProcessService;

	public AplicacionBusquedaConverter() {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object value)
			throws ConverterException {
		// TODO Auto-generated method stub
		return configJProcessService.selectAplicacionBusquedaById(Integer.parseInt(value.toString())).getAplicacion();	
	}
