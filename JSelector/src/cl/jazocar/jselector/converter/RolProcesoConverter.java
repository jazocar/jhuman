...
@FacesConverter(value = "rolProcesoConverter")
public class RolProcesoConverter implements Converter {
	
	private IConfigJProcessService configJProcessService;		
	
	public RolProcesoConverter(){
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object value)
			throws ConverterException {
		// TODO Auto-generated method stub
		return configJProcessService.selectRolProcesoById(Integer.parseInt(value.toString())).getNombre();
	}
